...
<file_map>
/Users/andersbekkevard/.config/nvim-vetle
└── init.lua *
├── lua
│   └── custom
│       └── plugins.lua *
...
<file_contents>
File: /Users/andersbekkevard/.config/nvim-vetle/lua/custom/plugins.lua
```lua
return { {
  'j-hui/fidget.nvim',
  tag = 'legacy',
...
File: /Users/andersbekkevard/.config/nvim-vetle/init.lua
```lua
-- Install Lazy
--
